...
function reposition(){
    document.getElementById("info").style.left=(window.innerWidth-document.getElementById("info").offsetWidth)/2+"px"
document.getElementById("info").style.top=(window.innerHeight-document.getElementById("info").offsetHeight-100)/2+"px"
